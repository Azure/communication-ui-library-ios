...
struct IconButton: View {
    ...
    var width: CGFloat {
        switch viewModel.buttonType {
        case .controlButton, .roundedRectButton:
            return 60
        case .infoButton:
            return iconImageSize
        case .dismissButton:
            return 16
        case .cameraSwitchButtonFull, .cameraSwitchButtonPip:
            return 36
        }
    }
    var height: CGFloat {
    ...
    var buttonBackgroundColor: Color {
        ...
        case .controlButton, .infoButton, .dismissButton:
            return .clear
        case .cameraSwitchButtonFull, .cameraSwitchButtonPip:
    ...
    var tappableWidth: CGFloat {
        switch viewModel.buttonType {
        case .cameraSwitchButtonPip, .cameraSwitchButtonFull, .infoButton:
            return 44
        default:
            return width
        }
    ...
    var shapeCornerRadius: CGFloat {
        switch viewModel.buttonType {
        case .cameraSwitchButtonPip, .cameraSwitchButtonFull:
            return 4
        default:
            return 8
        }
