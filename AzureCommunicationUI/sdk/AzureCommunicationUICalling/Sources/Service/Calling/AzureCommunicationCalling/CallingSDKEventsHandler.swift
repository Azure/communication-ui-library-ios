...
extension CallingSDKEventsHandler: CallDelegate,
    ...
    func onEntryUpdated(_ realTextCallFeature: RealTimeTextCallFeature,
                        args: RealTimeTextInfoChangedEventArgs) {
        rttReceived.send(args.entry.toCallCompositeRttData())
    }
