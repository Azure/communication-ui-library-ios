...
struct CaptionsErrorHeaderView: View {
    @ObservedObject var viewModel: CaptionsErrorHeaderViewModel
    ...
    var errorIcon: some View {
        Icon(name: .captionsError, size: 24)
