...
class CaptionsInfoCellViewModel {
    ...
    func getCellAccessibilityLabel(with participantViewData: ParticipantViewData?) -> String {
        return "\(getCellDisplayName(with: participantViewData))"
    }
...
extension CaptionsInfoCellViewModel: Equatable {
     static func == (lhs: CaptionsInfoCellViewModel,
                     rhs: CaptionsInfoCellViewModel) -> Bool {
