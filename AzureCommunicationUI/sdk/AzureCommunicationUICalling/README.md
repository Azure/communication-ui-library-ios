...
- [1.11.0-beta.1 release](https://github.com/Azure/communication-ui-library-ios/releases/tag/AzureCommunicationUICalling_1.11.0-beta.1) 
...
```ruby
pod 'AzureCommunicationUICalling', '1.11.0-beta.1'
```
