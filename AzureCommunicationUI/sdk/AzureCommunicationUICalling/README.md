...
- [1.8.0-beta.1 release](https://github.com/Azure/communication-ui-library-ios/releases/tag/AzureCommunicationUICalling_1.8.0-beta.1) 
...
```ruby
pod 'AzureCommunicationUICalling', '1.8.0-beta.1'
```
