Pod::Spec.new do |spec|
  ...
  spec.source               = { :git => 'https://github.com/Azure/communication-ui-library-ios.git', :tag => 'AzureCommunicationUICalling_1.4.0-beta.2' }
  ...
  spec.dependency             'AzureCommunicationCalling', '2.4.0-beta.2'
