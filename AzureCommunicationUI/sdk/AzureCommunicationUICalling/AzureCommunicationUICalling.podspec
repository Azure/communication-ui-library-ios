Pod::Spec.new do |spec|
  ...
  spec.source               = { :git => 'https://github.com/Azure/communication-ui-library-ios.git', :tag => 'AzureCommunicationUICalling_1.13.0' }
  ...
  spec.dependency             'AzureCommunicationCalling', '2.14.1'
