Pod::Spec.new do |spec|
  ...
  spec.source               = { :git => 'https://github.com/Azure/communication-ui-library-ios.git', :tag => 'AzureCommunicationUICalling_1.14.0-beta.1' }
  ...
  spec.dependency             'AzureCommunicationCalling', '2.15.0-beta.1'
