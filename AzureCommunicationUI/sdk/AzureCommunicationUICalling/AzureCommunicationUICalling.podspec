Pod::Spec.new do |spec|
  ...
  spec.source               = { :git => 'https://github.com/Azure/communication-ui-library-ios.git', :tag => 'AzureCommunicationUICalling_2.0.0' }
  ...
  spec.dependency             'AzureCommunicationCalling', '3.0.0'
