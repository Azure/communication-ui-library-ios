Pod::Spec.new do |spec|
  ...
  spec.source               = { :git => 'https://github.com/Azure/communication-ui-library-ios.git', :tag => 'AzureCommunicationUIChat_1.0.0-beta.5' }
  ...
  spec.dependency             'AzureCommunicationChat', '1.3.7'
