...
@_spi(common) public class Store<State, Action>: ObservableObject {

    @Published public var state: State

    private var dispatchFunction: ActionDispatch<Action>!
    private let reducer: Reducer<State, Action>
    private let actionDispatchQueue = DispatchQueue(label: "ActionDispatchQueue")

    public init(reducer: Reducer<State, Action>,
