...
/// User-configurable options for creating CallWithChatComposite.
public struct CallWithChatCompositeOptions {
    private(set) var themeOptions: ThemeOptions?
    private(set) var localizationOptions: LocalizationOptions?

    /// Creates an instance of CallWithChatCompositeOptions with related options.
