...
public struct SupportedLocale {
    ...
    public static var values: [Locale] {
        return Bundle(for: CallWithChatComposite.self).localizations.sorted()
...
public struct LocalizationOptions {
    ...
    ///  CallWithChat Composite's localization key or to provide translation for an custom language.
