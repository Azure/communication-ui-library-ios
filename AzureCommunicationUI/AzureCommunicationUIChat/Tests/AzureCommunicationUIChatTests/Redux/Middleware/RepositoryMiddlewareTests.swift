...
//    }
//
//    private func getEmptyChatMiddlewareFunction() -> (@escaping ChatActionDispatch) -> ChatActionDispatch {
//        return mockMiddleware.apply(getEmptyDispatch(), getEmptyState)
//    }
//
//    private func getAssertSameActionDispatch(action: Action, expectation: XCTestExpectation) -> ChatActionDispatch {
