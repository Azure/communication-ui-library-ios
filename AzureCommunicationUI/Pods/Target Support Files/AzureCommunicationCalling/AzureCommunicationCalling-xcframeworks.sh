...
install_xcframework "${PODS_ROOT}/AzureCommunicationCalling/AzureCommunicationCalling.xcframework" "AzureCommunicationCalling" "framework" "ios-arm64" "ios-x86_64-simulator"
